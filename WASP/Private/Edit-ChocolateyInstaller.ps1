function Edit-ChocolateyInstaller {
    ...
    begin {
        ...
        try {
            ...
            $VersionHistory = Get-LocalPackageVersionHistory $ParentSWDirectory
            # Test if a previous chocolateyInstall file exist.
            if ($VersionHistory) {
                $LastVersion = $VersionHistory[1] # 0 is the current, 1 the
